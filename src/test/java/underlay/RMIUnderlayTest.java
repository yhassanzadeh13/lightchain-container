...
/**
 * RMIUnderlay Unit Tests to make sure messages are sent/received correctly.
 * The tests are done through mocking.
 */
public class RMIUnderlayTest {
    ...
    public void RightNumIDTest() throws RemoteException, FileNotFoundException {
        ...
        RMIUnderlay.setTargetRMI(targetRMI);          // method created just for testing purposes
